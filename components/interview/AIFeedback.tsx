        ...
        <div className="bg-gradient-to-r from-brand-primary/10 to-brand-secondary/10 border border-brand-primary/20 rounded-2xl p-6 shadow-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-foreground-light dark:text-white mb-2">
              ...
              <div className="flex items-center gap-2 text-sm text-foreground-light-muted dark:text-foreground-dark-subtle">
                ...
                <span className="text-foreground-light-muted dark:text-foreground-dark-subtle">•</span>
